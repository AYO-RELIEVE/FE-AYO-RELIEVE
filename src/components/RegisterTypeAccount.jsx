    ...
    <section className="">
      ...
      <div>
        {/* <button className="btn btn-type-acc"  type="button"> */}
          <Link to={"/register-applicant"} className="text-decoration-none d-flex align-items-center justify-content-center btn btn-type-acc">Pelamar</Link>
        {/* </button> */}
      </div>
      <div>
         <Link to={"/register-organization"} className="text-decoration-none d-flex align-items-center justify-content-center btn btn-type-acc">Organisasi</Link>
      </div>
      </div>
    </section>
  );
